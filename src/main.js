...
const CONFIG = {
  ...
  slime: {
    ...
    size:      3.5,    // 中身の半径
    pressure:  190,    // 内圧＝表面張力的な張り。大きいほどプルッと丸く張る
    stiffness: 0.18,   // バネの硬さ。小さいほど変形しやすい（とろっと流れる）
    damping:   0.99,   // 速度減衰。1に近いほどよく揺れる（プルプル）
    smooth:    0.55,   // 表面のしわ取り＝表面張力で滑らかな膜にする
    shape:     0.012,  // 形状記憶。小さく＝固さ控えめ（丸めは張力/内圧が主に担う）
  },
